...
describe AirplaneSeating::Plane do
  ...
  describe '#initialize' do
    it 'should set priorities for all seats' do
      ...
      expect(plane.seat(1, 0).priority).to eq(AirplaneSeating::Seat::WINDOW)
      expect(plane.seat(1, 1).priority).to eq(AirplaneSeating::Seat::MIDDLE)
      expect(plane.seat(1, 2).priority).to eq(AirplaneSeating::Seat::AISLE)
      expect(plane.seat(1, 3).priority).to eq(AirplaneSeating::Seat::AISLE)
      expect(plane.seat(1, 4).priority).to eq(AirplaneSeating::Seat::MIDDLE)
      expect(plane.seat(1, 5).priority).to eq(AirplaneSeating::Seat::MIDDLE)
      expect(plane.seat(1, 6).priority).to eq(AirplaneSeating::Seat::AISLE)
      expect(plane.seat(1, 7).priority).to eq(AirplaneSeating::Seat::AISLE)
      expect(plane.seat(1, 8).priority).to eq(AirplaneSeating::Seat::AISLE)
      expect(plane.seat(1, 9).priority).to eq(AirplaneSeating::Seat::AISLE)
      expect(plane.seat(1, 10).priority).to eq(AirplaneSeating::Seat::MIDDLE)
      expect(plane.seat(1, 11).priority).to eq(AirplaneSeating::Seat::WINDOW)

      expect(plane.seat(2, 3).priority).to eq(AirplaneSeating::Seat::AISLE)
      expect(plane.seat(2, 4).priority).to eq(AirplaneSeating::Seat::MIDDLE)
      expect(plane.seat(2, 5).priority).to eq(AirplaneSeating::Seat::MIDDLE)
      expect(plane.seat(2, 6).priority).to eq(AirplaneSeating::Seat::AISLE)
      expect(plane.seat(2, 7).priority).to eq(AirplaneSeating::Seat::AISLE)
      expect(plane.seat(2, 8).priority).to eq(AirplaneSeating::Seat::AISLE)
      expect(plane.seat(2, 9).priority).to eq(AirplaneSeating::Seat::AISLE)
      expect(plane.seat(2, 10).priority).to eq(AirplaneSeating::Seat::MIDDLE)
      expect(plane.seat(2, 11).priority).to eq(AirplaneSeating::Seat::WINDOW)
    end
  end
